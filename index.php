...
<html>
	...
	<body>
		...
		<div class="hero">
			...
			<div class="hero__image" style="background-image: url( images/content/ );"></div>
		</div>
		...
		<div class="section section--text-align-left position-relative">
							...
							<div class="col-12">
								<div class="filter-form">
									<div>
										...
										<!-- <div class="row filter-form--more-options js-filter-form-more-options">
											<div class="col-12">
												<div class="filter-form__main">
													<div class="position-relative">
														<select type="option" class="filter-form__item js-vehicles-filter-color">
															<option value="" selected>Choose housing conditions:</option>

															<option value="Lives in a house">Lives in a house</option>
				
															<option value="Lives in appartment">Lives in appartment</option>
				
															<option value="Has yard">Has yard</option>
														</select>
													...
													<div class="position-relative">
														<select type="option" class="filter-form__item js-vehicles-filter-doors">
															<option value="" selected>Choose number of doors:</option>
													...
													<div class="position-relative">
														<select type="option" class="filter-form__item js-vehicles-filter-fuel">
									...
									<div>
										<!-- <a href="#" class="button button--orange button--sm button--filled button--ml-md js-filter-form--more-options-button">+</a> -->
				...
				<div class="row position-relative">
					<div class="col-12 col-6-lg col-5-xl">
						...
						<div class="row">
							<div class="col-12">
								<div class="text">
									<p class="text--mb-sm">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam pulvinar diam nec mauris egestas vehicula. Maecenas diam lectus, cursus eu metus et, rhoncus dignissim turpis. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec vel tellus purus.</p>

									<p class="text--mb-sm">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam pulvinar diam nec mauris egestas vehicula. Maecenas diam lectus.</p>

									<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam pulvinar diam nec mauris egestas vehicula. Maecenas diam lectus, cursus eu metus et, rhoncus dignissim turpis.</p>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="col-12">
						<div class="footer__inner">
							...
							<ul class="social-media-list">
								<li class="social-media-list__item"><a href="#">
