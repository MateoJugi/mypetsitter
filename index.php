...
<html>
	...
	<body>
		...
		<div class="hero" style="background-image: url( images/content/dog-and-woman.jpg );">
			<div class="container">
		...
		<div class="section theme-background-color">
			<div class="container">
				<div class="row">
					<div class="col-12">
						<h3 class="title title--sm text-transform-uppercase title--mb-xs">How it works</h3>
					</div>
				</div>

				<div class="row">
					<div class="col-12 col-6-lg col-offset-3-lg">
						<h4 class="title title--lg title--mb-lg theme-on-surface-color">Find your local pet sitters in the easiest way</h4>
					</div>
				</div>

				<div class="row">
					<div class="col-12 col-6-sm col-4-lg">
						<div class="icon-wrapper theme-surface-color">
						...
						<h5 class="title title--md title--mt-md title--mb-sm theme-on-surface-color">Find someone you like</h5>
					...
					<div class="col-12 col-6-sm col-4-lg">
						...
						<h5 class="title title--md title--mt-md title--mb-sm theme-on-surface-color">Meet up</h5>
					...
					<div class="col-12 col-6-sm col-4-lg">
						...
						<h5 class="title title--md title--mt-md title--mb-sm theme-on-surface-color">Relax and enjoy</h5>

						<div class="text text--mb-md">
							<p>Knowing your pet is in good hands you can relax and do anything else.</p>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="section section--text-align-left section--pt-pb-lg position-relative theme-background-color">
			...
			<div class="container">
				<div class="row">
					<div class="col-12 col-6-lg col-offset-6-lg">
						<div class="row">
							<div class="col-12">
								<h3 class="title title--sm text-transform-uppercase title--mb-xs">Best services</h3>
							</div>
						</div>
		
						<div class="row">
							<div class="col-12">
								<h4 class="title title--lg title--mb-lg theme-on-surface-color">Feel the best experience with our sitter services</h4>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-12">
								<div class="display-flex">
									<div>
										<div class="icon-wrapper icon-wrapper--sm theme-surface-color">
									...
									<div>
										<h5 class="title title--md title--mb-xs theme-on-surface-color">Pet walking</h5>
						...
						<div class="row">
							<div class="col-12">
								<div class="display-flex">
									...
									<div>
										<h5 class="title title--md title--mb-xs theme-on-surface-color">Boarding</h5>
						...
						<div class="row">
							<div class="col-12">
								<div class="display-flex">
									...
									<div>
										<h5 class="title title--md title--mb-xs theme-on-surface-color">House sitting</h5>
			...
			<div class="container">
				<div class="row">
					<div class="col-12">
						<div class="row">
							<div class="col-12">
								<h3 class="title title--sm text-transform-uppercase title--mb-xs">Meet now</h3>
							</div>
						</div>
		
						<div class="row">
							<div class="col-12 col-6-lg col-offset-3-lg">
								<h4 class="title title--lg title--mb-md theme-on-surface-color">Find your local pet sitter</h4>
							</div>
						</div>
		...
		<div class="section section--text-align-left section--pb-lg theme-background-color">
			...
			<div class="container">
				<div class="row position-relative">
					<div class="col-12 col-6-lg col-5-xl">
						<div class="row">
							<div class="col-12">
								<h3 class="title title--sm text-transform-uppercase title--mb-xs">About us</h3>
							</div>
						</div>
		
						<div class="row">
							<div class="col-12">
								<h4 class="title title--lg title--mb-md theme-on-surface-color">Get to know us</h4>
							</div>
						</div>
		...
		<div class="white-pop-up white-pop-up--title-lg white-pop-up--orange-before mfp-hide theme-background-color" id="sign-up-pop-up">
			<form class="form" enctype="multipart/form-data" onsubmit="return false">
				<h3 class="title title--lg title--white title--mb-lg theme-on-surface-color">Create<br> Account</h3>

				<div class="radio-option-select theme-on-surface-color">
					<div class="radio-option-select__item radio-option-select__item--active js-radio-option-select-item">as User</div>

					<div class="radio-option-select__item js-radio-option-select-item">as Sitter</div>
				</div>
				...
				<div class="form__item">
					...
					<input type="email" class="form__input form__input--orange js-sign-up-email theme-surface-color" placeholder="Email" required />
				</div>
				...
				<div class="form__item js-sitter-sign-up-item">
					...
					<input type="text" class="form__input form__input--orange js-sign-up-location input-datalist theme-surface-color" list="form-input-location" placeholder="City" required />
				...
				<div class="form__item js-sitter-sign-up-item">
					...
					<input type="number" class="form__input form__input--orange js-sign-up-price theme-surface-color" placeholder="Price /day" required />
				</div>
				...
				<div class="form__item js-sitter-sign-up-item">
					...
					<!-- <input type="file" name="image" class="form__input form__input--orange js-sign-up-image theme-surface-color" accept="image/x-png,image/gif,image/jpeg" required/> -->
				...
				<div class="form__item js-sitter-sign-up-item">
					...
					<textarea class="form__input form__input--orange form__input--textarea js-sign-up-about theme-surface-color" placeholder="Small text about yourself" rows="5" required></textarea>
				</div>
		...
		<div class="white-pop-up white-pop-up--title-lg mfp-hide theme-background-color" id="sign-in-pop-up">
			<form class="form" enctype="multipart/form-data" onsubmit="return false">
				...
				<div class="form__item">
					...
					<input type="text" class="form__input js-sign-in-email theme-surface-color" placeholder="Email" required>
				</div>
				...
				<div class="form__item">
					...
					<svg class="form__icon form__icon--second form__icon--password-reveal form-icon-stroke" enable-background="new 0 0 32 32" id="Editable-line" version="1.1" viewBox="0 0 32 32" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><path d="  M16,7C9.934,7,4.798,10.776,3,16c1.798,5.224,6.934,9,13,9s11.202-3.776,13-9C27.202,10.776,22.066,7,16,7z" fill="none" id="XMLID_10_" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="2"/><circle cx="16" cy="16" fill="none" id="XMLID_12_" r="5" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="2"/>
					</svg>
				</div>
				...
				<div class="row">
					<div class="col-12">
						<div class="footer__inner">
							<div class="site-logo site-logo--sm theme-on-surface-color">
								<a href="#">myPetSitter</a>
							</div>
