						...
						<div class="white-pop-up white-pop-up--title-lg white-pop-up--orange-before theme-surface-color">
							<form class="form" enctype="multipart/form-data" onsubmit="return false">
								...
								<div class="form__item">
									...
									<select class="js-select2 form__input form__input--orange js-sitter-profile-changes-prefered-pet js-filter-prefered-pets-request-select2 js-select2--tags theme-surface-color" name="states[]" multiple="multiple" style="width: 100%;" id="mySelect2" data-placeholder="Prefered pets" required >
										<?php
								...
								<div class="form__item">
									...
									<select class="js-select2 form__input form__input--orange js-sitter-profile-changes-service theme-surface-color" name="states[]" multiple="multiple" style="width: 100%;" data-placeholder="Services" required>
										<?php
