	...
	<body>
						...
						<div class="white-pop-up white-pop-up--title-lg white-pop-up--orange-before theme-surface-color">
							<form class="form" enctype="multipart/form-data" onsubmit="return false">
								...
								<div class="form__item">
									...
									<input type="text" class="form__input form__input--orange js-sign-up-fullname theme-surface-color" placeholder="Full name" required value="<?php echo $signInSitterFullName?>"/>
								</div>
								...
								<div class="form__item">
									...
									<input type="email" class="form__input form__input--orange js-sign-up-email theme-surface-color" placeholder="Email" required value="<?php echo $signInSitterEmail?>"/>
								</div>
								...
								<div class="form__item">
									...
									<input type="text" class="form__input form__input--orange js-sign-up-location input-datalist theme-surface-color" list="form-input-location" placeholder="City" required value="<?php echo $signInSitterLocation?>"/>
								...
								<div class="form__item">
									...
									<select class="js-select2 form__input form__input--orange js-sign-up-prefered-pet js-filter-prefered-pets-request-select2 js-select2--tags theme-surface-color" name="states[]" multiple="multiple" style="width: 100%;" id="mySelect2" data-placeholder="Prefered pets" required >
										<?php
											foreach( $signInSitterPreferedPets as $pets ) {
												echo '<option value="'.$pets.'" selected>'.$pets.'</option>';
											}
										?>
									</select>
								...
								<div class="form__item">
									...
									<select class="js-select2 form__input form__input--orange js-sign-up-service theme-surface-color" name="states[]" multiple="multiple" style="width: 100%;" data-placeholder="Services" required>
										<?php
											foreach( $signInSitterPreferedServices as $service ) {
								...
								<div class="form__item">
									...
									<input type="number" class="form__input form__input--orange js-sign-up-price theme-surface-color" placeholder="Price /day" required value="<?php echo $signInSitterPrice?>"/>
								</div>
								...
								<div class="form__item">
									...
									<input type="url" class="form__input form__input--orange js-sign-up-image theme-surface-color" placeholder="Image url" required value="<?php echo $signInSitterImage?>"/>
								...
								<div class="form__item">
									...
									<textarea class="form__input form__input--orange form__input--textarea js-sign-up-about theme-surface-color" placeholder="Small text about yourself" rows="5" required><?php echo $signInSitterAbout?></textarea>
								</div>
								...
								<div class="form__item">
									...
									<input type="text" class="form__input form__input--orange js-sign-up-password theme-surface-color" placeholder="Password" required value="<?php echo $signInSitterPassword?>"/>
								...
								<input type="submit" value="Save changes" class="button button--xl button--filled button--orange button--mt-sm button--mr-ml-none js-profile-changes-button" data-sitterID = "<?php echo $signInSitterID?>">
		...
		<script>
			...
			$( document ).on('click', '.select2-selection', function () { 
				$( ".js-sign-up-service option" ).each( function() {
					arr.push( $( this ).val() );
					arr = [ ...new Set( arr ) ];
				} );

				/* for ( index in arr ) {
					$( '.select2-results__options' ).append( '<li class="select2-results__option select2-results__option--selectable" id="select2-mySelect2-result-0313-'+arr[index]+'" role="option" data-select2-id="select2-data-select2-mySelect2-result-0313-'+arr[index]+'" aria-selected="false">'+arr[index]+'</li>' );
				} */
			} );
		</script>
