	...
	<body>
						...
						<div class="white-pop-up white-pop-up--title-lg white-pop-up--orange-before theme-surface-color">
							<form class="form" enctype="multipart/form-data" onsubmit="return false">
								...
								<div class="form__item">
									...
									<input type="text" class="form__input form__input--orange js-profile-changes-fullname js-profile-changes-fullname-duplicates theme-surface-color" placeholder="Full name" required value="<?php echo $signInSitterFullName ?>"/>
								</div>
								...
								<div class="form__item">
									...
									<input type="email" class="form__input form__input--orange js-profile-changes-email js-profile-changes-email-duplicates theme-surface-color" placeholder="Email" required value="<?php echo $signInSitterEmail ?>"/>
								</div>
								...
								<div class="form__item">
									...
									<input type="text" class="form__input form__input--orange js-profile-changes-location input-datalist theme-surface-color" list="form-input-location" placeholder="City" required value="<?php echo $signInSitterLocation ?>"/>
								...
								<div class="form__item">
									...
									<select class="js-select2 form__input form__input--orange js-profile-changes-prefered-pets js-filter-prefered-pets-request-select2 js-select2--tags theme-surface-color" name="states[]" multiple="multiple" data-placeholder="Prefered pets" required></select>
								...
								<div class="form__item">
									...
									<select class="js-select2 form__input form__input--orange js-profile-changes-prefered-services theme-surface-color" name="states[]" multiple="multiple" data-placeholder="Prefered services" required>
								...
								<div class="form__item">
									...
									<input type="number" class="form__input form__input--orange js-profile-changes-price theme-surface-color" placeholder="Price /day" required value="<?php echo $signInSitterPrice ?>"/>
								</div>
								...
								<div class="form__item">
									...
									<input type="url" class="form__input form__input--orange js-profile-changes-image theme-surface-color" placeholder="Image url" required value="<?php echo $signInSitterImage ?>"/>
								...
								<div class="form__item">
									...
									<textarea class="form__input form__input--orange form__input--textarea js-profile-changes-about theme-surface-color" placeholder="Small text about yourself" rows="5" required><?php echo $signInSitterAbout ?></textarea>
								</div>
								...
								<div class="form__item">
									...
									<input type="password" class="form__input form__input--orange js-profile-changes-password js-form-input-password theme-surface-color" placeholder="Password" minlength="5" required value="<?php echo $signInSitterPassword ?>"/>
		...
		<script>
			...
			$( document ).ajaxStop( function() {
				...
				setTimeout( function() {
					$( '.js-profile-changes-prefered-services' ).val( signInSitterPreferedServices ).trigger( 'change' );
				}, 100 );
