...
<html>
    ...
    <body>
		...
		<script>
			...
			/* ----- Saving user informations inside session ----- */

			let userFullName = $( '.js-profile-changes-fullname' ).val();
			let userEmail = $( '.js-profile-changes-email' ).val();
			let userContactNumber = $( '.js-profile-changes-contact-number' ).val();

			sessionStorage.setItem( 'userFullName', userFullName );
			sessionStorage.setItem( 'userEmail', userEmail );
			sessionStorage.setItem( 'userContactNumber', userContactNumber );
		</script>
