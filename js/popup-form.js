$( document ).on( 'click', '.js-popup-form', function( e ) {
	...
	let sitterPreferedPetOptionInput = "";

	for( index in sitterPreferedPet ) {
		sitterPreferedPetOptionInput += '<option value="' + sitterPreferedPet[index] + '">';
	}
		...
		items: {
			...
			'<form class="form" onsubmit="return false">'+
				...
				'<div class="form__item">'+
					...
					'<input type="text" class="form__input form__input--pl-sm js-popup-customerPet input-datalist" list="form-input-pets" placeholder="Choose pet:" required>'+
