$( document ).on( 'click', '.js-popup-form', function( e ) {
	...
	for( index in sitterPreferedPet ) {
		sitterPreferedPetOptionInput += '<option value="' + sitterPreferedPet[index] + '">' + sitterPreferedPet[index] + '</option>';
	}
		...
		items: {
			...
			'<form class="form" onsubmit="return false">'+
				...
				'<div class="form__item">'+
					...
					'<select type="option" class="form__input form__input--pl-sm js-popup-customerPet" required />'+
