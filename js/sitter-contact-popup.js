	...
	if ( isUserLogedIn == 'yes' ) {
			...
			items: {
				...
				'<form class="form" onsubmit="return false">'+
					'<div class="form__item">'+
						...
						'<input type="text" class="form__input js-popup-customerFullName theme-surface-color" value="' + userFullName + '" disabled="disabled"/>'+
					'</div>'+
					...
					'</svg>'+
						...
						'<input type="email" class="form__input js-popup-customerEmail theme-surface-color" value="' + userEmail + '" disabled="disabled"/>'+
					'</div>'+
					...
					'<div class="form__item">'+
						...
						'<input type="number" class="form__input js-popup-customerContactNumber theme-surface-color" value="' + userContactNumber + '" disabled="disabled"/>'+
					'</div>'+
		...
		$.magnificPopup.open( {
			items: {
				...
				'<p class="text text--md text--black theme-on-surface-color">You need to be signed in to contact sitters.</p>'+
			'</div>',
			},
			type: 'inline',
			removalDelay: 300,
