/* FUNCTIONS */
	...
	/* ----- Adding first 4 sitters to first page (function1) ----- */
	...
	/* ----- Generating pagination depending on number of sitters per page (function2) ----- */
	...
	function userLogedIn() {
		...
		sessionStorage.setItem( 'isUserLogedIn', 'yes');
...
/* EVENTS */
	...
	/* ----- On load execute function1 and function2 ----- */
	...
	/* ----- Profile sign out request ----- */

	$( document ).on( 'click', '.js-profile-sign-out-button', function() {
		var xhttp = new XMLHttpRequest();

		xhttp.open( 'GET', 'php/profile-sign-out-request.php', true );
		xhttp.send();
	...
	$( document ).on( 'click', '.js-to-user-profile-page', function ( e ) {
		e.preventDefault();
	...
	/* ----- Inserting options inside pets filter select and select2 ----- */
